  ...
  <section>
    <div class="page-header">
      <div>
        ...
        <h1>接口扫描</h1>
        <p class="subtext">扫描源码包或制品包，按接口维度查看命中次数和关联用例。</p>
      </div>
      <div class="header-actions">
        <RouterLink class="secondary-link" :to="`/p/${projectId}/apps/${appId}/versions`">返回版本中心</RouterLink>
...
async function uploadArtifact() {
  ...
  try {
    ...
    notice.value = err instanceof Error ? err.message : '接口扫描失败'
  } finally {
