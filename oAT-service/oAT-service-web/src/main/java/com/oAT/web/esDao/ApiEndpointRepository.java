    ...
    public ApiEndpointIndex save(ApiEndpointIndex endpoint) {
        ...
        jdbcTemplate.update("""
                        ...
                        ON DUPLICATE KEY UPDATE
                            ...
                            source_type_names = VALUES(source_type_names),
                            endpoint_type = VALUES(endpoint_type),
                            url = VALUES(url),
                            http_method = VALUES(http_method),
                            class_name = VALUES(class_name),
                            class_names = VALUES(class_names),
                            method_name = VALUES(method_name),
                            method_names = VALUES(method_names),
                            method_desc = VALUES(method_desc),
                            method_descs = VALUES(method_descs),
                            covered = VALUES(covered),
                            hit_count = VALUES(hit_count),
                            merged_source_count = VALUES(merged_source_count),
